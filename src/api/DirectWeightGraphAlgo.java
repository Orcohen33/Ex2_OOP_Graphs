...
public class DirectWeightGraphAlgo implements DirectedWeightedGraphAlgorithms {
    ...
    public static void main(String[] args) {
        ...
        //Nodes
//        dwg.addNode(new api.Node(new Point3D(1,5,0),0));
//        dwg.addNode(new api.Node(new Point3D(4,7,0),1));
//        dwg.addNode(new api.Node(new Point3D(5,3,0),2));
//        dwg.addNode(new api.Node(new Point3D(2,1,0),3));
//        //Edges
//        dwg.connect(0,1,1.5);
//        dwg.connect(1,0,1.6);
//        dwg.connect(1,2,3);
